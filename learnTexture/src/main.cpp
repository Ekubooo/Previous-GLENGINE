...
void my_transMit(map<string ,glm::mat4>& transCon)
{
    // 位移
    ...
    //  glm::rotate(transCon["modelMat"], (float)glfwGetTime() * glm::radians(50.0f), glm::vec3(0.5f, 1.0f, 0.0f));
    transCon["viewMat"] = 
...
//渲染循环
void my_renderLoop
(GLFWwindow* window, Shader* myShader, unsigned int& VAO, unsigned int& EBO, 
 map<string ,glm::mat4>& transCon, map<string,unsigned int>& myTexBuffer)
{
    ...
    {   
        ...
        my_drawCall(transCon,myShader);  // uniform + drawArray 
...
{   
    ...
    my_transMit(transCon);                  // 矩阵变换 MVP
    my_renderLoop                           // 渲染循环
        (window,myShader,VAO,EBO,transCon,myTexBuffer); 
    glfwTerminate();
    return 0;
}
/////////////////////////////////////////////////////////////////////////////////////////////
