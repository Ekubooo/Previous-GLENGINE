...
(map<string,unsigned int>& myTexBuffer)
{
    ...
    //GPULoadImage(myTextureImage1,GL_RGBA,GL_RGBA,Shader::DIFFUSE);
}
...
{   
    ...
    myMaterial->_myShader->serUniform1Img("material.diffuse", 0);
    myMaterial->_myShader->serUniform1Img("material.specular", 1);
...
{   
    ...
    Material* myMaterial = new Material     // 初始化材质类
        (myShader, myTexBuffer["diffuse"], myTexBuffer["specular"], ambient, shininess); 
